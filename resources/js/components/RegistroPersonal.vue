    ...
    <form-wizard @onComplete="onComplete" style="width: 70%;">
        ...
        <tab-content title="Detalles personales" icon="ti-user">
            <div class="row justify-content-md-center">
                <h4>Selecciona Renglón Presupuestario</h4>
                <br />
            </div>
            <div class="row justify-content-md-center">
            ...
            >
                <div class="col-md-6 py-3">
                    ...
                    />
                    <div
                        v-if="hasError('primer_nombre')"
                        class="invalid-feedback"
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.primer_nombre.required"
                        >
                            Campo requerido.
                        </div>
                        <div
                            class="error"
                            v-if="!$v.formData.primer_nombre.minLength"
                        >
                ...
                <div class="col-md-6 py-3">
                    ...
                    />
                    <div
                        v-if="hasError('segundo_nombre')"
                        class="invalid-feedback"
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.segundo_nombre.required"
                        >
                            Campo requerido.
                        </div>
                    </div>
            ...
            >
                <div class="col-md-6 py-3">
                    ...
                    />
                    <div
                        v-if="hasError('primer_apellido')"
                        class="invalid-feedback"
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.primer_apellido.required"
                        >
                            Campo requerido.
                        </div>
                    </div>
                ...
                <div class="col-md-6 py-3">
                    ...
                    <input
                        ...
                        :class="
                            hasError('segundo_apellido') ? 'is-invalid' : ''
                        "
                    />
                    <div
                        v-if="hasError('segundo_apellido')"
                        class="invalid-feedback"
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.segundo_apellido.required"
                        >
                            Campo requerido.
                        </div>
                    </div>
            ...
            >
                <div class="col-md-6 py-3">
                    ...
                    <input
                        class="form-control"
                        v-model="formData.apellido_casada"
            ...
            >
                <div class="col-md-6">
                    ...
                    <div v-if="hasError('picked')" class="invalid-feedback">
                        <div class="error" v-if="!$v.formData.picked.required">
                            Campo requerido.
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div v-if="hasError('fecha_nac')" class="invalid-feedback">
                        <div
                            class="error"
                            v-if="!$v.formData.fecha_nac.required"
                        >
                            Campo requerido.
                        </div>
                    </div>
            ...
            >
                <div class="col-md-6">
                    ...
                    <br />
                    <div
                        v-if="hasError('estado_civl')"
                        class="invalid-feedback"
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.estado_civl.required"
                        >
                            Campo requerido.
                        </div>
                    </div>
                ...
                <div v-if="hasError('lugar_nac')" class="invalid-feedback">
                    <div class="error" v-if="!$v.formData.lugar_nac.required">
                        Campo requerido.
                    </div>
                </div>
            </div>
            ...
            >
                <div class="col-md-6 py-3">
                    ...
                    <div v-if="hasError('dpi')" class="invalid-feedback">
                        <div class="error" v-if="!$v.formData.dpi.required">
                            Campo requerido.
                        </div>
                        <div
                            class="error"
                            v-if="
                                !$v.formData.dpi.minLength ||
                                    !$v.formData.dpi.minLength
                            "
                        >
                            Ingrese dpi válido.
                        </div>
                        <div class="error" v-if="!$v.formData.dpi.numeric">
            ...
            >
                ...
                <div v-if="hasError('nit')" class="invalid-feedback">
                    <div class="error" v-if="!$v.formData.nit.required">
                        Campo requerido.
                    </div>
                    <div
                        class="error"
                        v-if="
                            !$v.formData.nit.minLength ||
                                !$v.formData.dpi.minLength
                        "
                    >
                        Ingrese nit válido.
            ...
            >
                <div class="col-md-6 py-3">
                    ...
                    <select
                        ...
                        class="form-control"
                        :class="hasError('etnia') ? 'is-invalid' : ''"
                    >
                        <option
                    ...
                    <div v-if="hasError('etnia')" class="invalid-feedback">
                        <div class="error" v-if="!$v.formData.etnia.required">
                            Campo requerido.
                        </div>
                    </div>
                </div>
                <div class="col-md-6 py-3">
                    ...
                    <select
                        v-model="formData.comunidad"
                        class="form-control"
                        :class="hasError('comunidad') ? 'is-invalid' : ''"
                    >
                        <option
                    ...
                    <div v-if="hasError('comunidad')" class="invalid-feedback">
                        <div
                            class="error"
                            v-if="!$v.formData.comunidad.required"
                        >
                            Campo requerido.
                        </div>
                    </div>
        ...
        <tab-content title="Discapacidad">
            ...
            >
                ...
                <div
                    ...
                    :class="hasError('sensorial') ? 'is-invalid' : ''"
                >
                    <input
                        class="form-check-input"
                        type="radio"
                ...
                <div v-if="hasError('sensorial')" class="invalid-feedback">
                    <div class="error" v-if="!$v.formData.sensorial.required">
                        Campo requerido.
                    </div>
                </div>
            </div>
            ...
            >
                ...
                <div
                    class="form-check form-check-inline"
                    :class="hasError('motriz') ? 'is-invalid' : ''"
                >
                    <input
                        class="form-check-input"
                        type="radio"
                        ...
                        id="inlineCheck1"
                        value="1"
                        v-model="formData.motriz"
                    />
                    <label class="form-check-label" for="inlineCheck1"
                        >Extremidades inferiores</label
                    >
                </div>
                <div
                    class="form-check form-check-inline"
                ...
                >
                    <input
                        ...
                        v-model="formData.motriz"
                    />
                    <label class="form-check-label" for="inlineCheck5"
                        >Tronco</label
                    >
                </div>
                <div
                ...
                >
                    <input
                        ...
                        v-model="formData.motriz"
                    />
                    <label class="form-check-label" for="inlineCheck6"
                        >Múltiple</label
                    >
                </div>
                <div
                ...
                >
                    <input
                        ...
                        v-model="formData.motriz"
                    />
                    <label class="form-check-label" for="inlineCheck7"
                        >Ninguna</label
                    >
                </div>
                <div v-if="hasError('motriz')" class="invalid-feedback">
                    <div class="error" v-if="!$v.formData.motriz.required">
                        Campo requerido.
                    </div>
                </div>
            </div>
            ...
            >
                ...
                <div
                    class="form-check form-check-inline"
                    :class="hasError('mental') ? 'is-invalid' : ''"
                >
                    <input
                        class="form-check-input"
                        type="radio"
                ...
                >
                    <input
                        ...
                        v-model="formData.mental"
                    />
                    <label class="form-check-label" for="mental4"
                        >Ninguna</label
                    >
                </div>
                <div v-if="hasError('mental')" class="invalid-feedback">
                    <div class="error" v-if="!$v.formData.mental.required">
                        Campo requerido.
                    </div>
                </div>
            </div>
        ...
        <tab-content title="Información Académica">
            ...
            >
                <div class="col-md-6 py-3">
                    ...
                    <select
                        v-model="formData.nivel_primario_s"
                        class="form-control"
                        :class="
                            hasError('nivel_primario_s') ? 'is-invalid' : ''
                        "
                    >
                        <option
                    ...
                    <div
                        v-if="hasError('nivel_primario_s')"
                        class="invalid-feedback"
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.nivel_primario_s.required"
                        >
                            Campo requerido.
                        </div>
                    </div>
            ...
            >
                <div class="col-md-6 py-3">
                    ...
                    <select
                        v-model="formData.nivel_basico_s"
                        class="form-control"
                        :class="hasError('nivel_basico_s') ? 'is-invalid' : ''"
                    >
                        <option
                    ...
                    <div
                        v-if="hasError('nivel_basico_s')"
                        class="invalid-feedback"
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.nivel_basico_s.required"
                        >
                            Campo requerido.
                        </div>
                    </div>
        ...
        <tab-content title="Datos Familiares">
            ...
            >
                <div class="col-md-6 py-3">
                    ...
                    <!-- <p>Message is: {{ primer_nombre }}</p> -->
                    <div
                        v-if="hasError('nombre_padre')"
                        class="invalid-feedback"
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.nombre_padre.required"
                        >
                            Campo requerido.
                        </div>
                    </div>
                ...
                <div class="col-md-6 py-3">
                    ...
                    />
                    <div
                        v-if="hasError('direccion_padre')"
                        class="invalid-feedback"
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.direccion_padre.required"
                        >
                            Campo requerido.
                        </div>
                    </div>
                ...
                <div class="col-md-6 py-3">
                    ...
                    />
                    <div
                        v-if="hasError('telefono_padre')"
                        class="invalid-feedback"
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.telefono_padre.required"
                        >
                            Campo requerido.
                        </div>
                        <div
                            class="error"
                            v-if="
                                !$v.formData.telefono_padre.minLength ||
                                    !$v.formData.telefono_padre.maxLength
                            "
                        >
                        ...
                        <div
                            class="error"
                            v-if="!$v.formData.telefono_padre.numeric"
                        >
                            Este campo solo debe tener números.
                        </div>
                    </div>
            ...
            >
                <div class="col-md-6 py-3">
                    ...
                    />
                    <div
                        v-if="hasError('nombre_madre')"
                        class="invalid-feedback"
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.nombre_madre.required"
                        >
                            Campo requerido.
                        </div>
                    </div>
                ...
                <div class="col-md-6 py-3">
                    ...
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.direccion_madre.required"
                        >
                            Campo requerido.
                        </div>
                    </div>
                ...
                <div class="col-md-6 py-3">
                    ...
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.telefono_madre.required"
                        >
                            Campo requerido.
                        </div>
                        <div
                            class="error"
                            v-if="
                                !$v.formData.telefono_madre.minLength ||
                                    !$v.formData.telefono_madre.maxLength
                            "
                        >
                            Ingrese No. de teléfono válido.
                        </div>
                        <div
                            class="error"
                            v-if="!$v.formData.telefono_madre.numeric"
                        >
                            Este campo solo debe tener números.
                        </div>
                    </div>
            ...
            >
                <div class="col-md-6 py-3">
                    ...
                    />
                    <div
                        v-if="hasError('nombre_conyuge')"
                        class="invalid-feedback"
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.nombre_conyuge.required"
                        >
                            Campo requerido.
                        </div>
                    </div>
                ...
                <div class="col-md-6 py-3">
                    ...
                    <input
                        ...
                        :class="
                            hasError('direccion_conyuge') ? 'is-invalid' : ''
                        "
                    />
                    <div
                        v-if="hasError('direccion_conyuge')"
                        class="invalid-feedback"
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.direccion_conyuge.required"
                        >
                            Campo requerido.
                        </div>
                    </div>
                ...
                <div class="col-md-6 py-3">
                    ...
                    <input
                        ...
                        :class="
                            hasError('telefono_conyugue') ? 'is-invalid' : ''
                        "
                    />
                    <div
                        v-if="hasError('telefono_conyugue')"
                        class="invalid-feedback"
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.telefono_conyugue.required"
                        >
                            Campo requerido.
                        </div>
                        <div
                            class="error"
                            v-if="
                                !$v.formData.telefono_conyugue.minLength ||
                                    !$v.formData.telefono_conyugue.maxLength
                            "
                        >
                            Ingrese No. de teléfono válido.
                        </div>
                        <div
                            class="error"
                            v-if="!$v.formData.telefono_conyugue.numeric"
                        >
                            Este campo solo debe tener números.
                        </div>
                    </div>
            ...
            >
                <div class="col-md-4 py-3">
                    ...
                    />
                    <div
                        v-if="hasError('cantidad_hijos')"
                        class="invalid-feedback"
                    >
                        <div
                            class="error"
                            v-if="!$v.formData.cantidad_hijos.required"
                        >
                            Campo requerido.
                        </div>
                    </div>
        ...
        <tab-content title="Información Laboral">
            ...
            >
                ...
                <div class="form-row justify-content-md-center">
                    <div class="col-md-6 py-3">
                        ...
                        <select
                            v-model="formData.puesto_nominal"
                            class="form-control"
                        >
                            <option
                                v-for="puesto in formData.puestos_nominales"
            ...
            <div v-if="formData.renglon === '029'">
                <div class="form-row justify-content-md-center">
                    <span>El renglón seleccionado es: </span>
                    <h3>{{ formData.renglon }}</h3>
                </div>
                <div class="form-row justify-content-md-center">
                    <div class="col-md-6 py-3">
