            ...
            <form>
              ...
              <div class="form-row">
                <div class="col-md-6">
                  ...
                  />
                  <p>Message is: {{ primer_apellido }}</p>
                </div>
                <div class="col-md-6">
                  ...
                  />
                  <p>Message is: {{ segundo_apellido }}</p>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <br />
                <input type="radio" id="two" value="Hombre" v-model="picked" />
                <label for="two">Hombre</label>
                <br />
                <span>Género: {{ picked }}</span>
              </div>
